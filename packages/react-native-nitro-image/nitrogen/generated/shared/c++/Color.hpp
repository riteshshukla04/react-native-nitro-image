...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::image::Color> final {
    static inline margelo::nitro::image::Color fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::image::Color(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::image::Color& arg) {
